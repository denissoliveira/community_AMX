...
{down = iCommandPlaneRadarOnOff, name = _('ELINT Pod On/Off'), category = _('Sensors')},{down = iCommandPlaneRadarCenter, name = _('Target Designator To Center'), category = _('Sensors')},
...
{down = CustomKeybinds.FireWeaponOn,	up = CustomKeybinds.FireWeaponOff, name = _('WEAPON RELEASE'), category = _('Weapons')},
...
--{down = Clickables.WING_30, name = _('Wing Sweep 30 degrees'), category = _('Systems')},
--{down = Clickables.WING_45, name = _('Wing Sweep 45 degrees'), category = _('Systems')},
--{down = Clickables.WING_60, name = _('Wing Sweep 60 degrees'), category = _('Systems')},
